...
#define ngx_http_v2_push_write_name(dst, src, len, tmp)                            \
    ngx_http_v2_push_string_encode(dst, src, len, tmp, 1)
#define ngx_http_v2_push_write_value(dst, src, len, tmp)                           \
    ngx_http_v2_push_string_encode(dst, src, len, tmp, 0)

u_char *ngx_http_v2_push_string_encode(u_char *dst, u_char *src, size_t len,
...
ngx_http_v2_node_t *ngx_http_v2_push_get_node_by_id(
